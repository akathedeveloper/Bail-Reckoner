...
const CaseList = () => {
  ...
  const getCaseStatus = (caseItem) => {
    ...
    if (legalAidValue.toLowerCase().startsWith("under review")) {
      ...
      return {
        color: "yellow",
        status: provider ? `Under Review by: ${provider}` : "Under Review",
        showButton: false,
      };
    }
    ...
    return {
      color: "green",
      status: `Accepted by: ${legalAidValue}`,
      showButton: false,
    };
  };
            ...
            <div key={caseItem.id} className="case-card">
              ...
              <div className="case-content">
                <div className="case-details">
                  ...
                  <p>
                    <strong>Custody Time:</strong> {caseItem.custodyTime}
                  </p>
                  <p>
                    <strong>Bail Amount:</strong> {caseItem.bailAmount}
                  </p>
                </div>
                <p>
                ...
                <div className="case-status">
                  {showButton ? (
                    <button
                      className={`find-aid-btn ${
                        color === "yellow" ? "under-review" : ""
                      }`}
